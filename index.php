        ...
        <div class="center">
            <form action="send_email.php" method="POST">
                ...
                <button type="submit">
                    <p>Inscris-toi !</p>
                    <div>
                        <img src="img/mail.png" alt="image mail vip">
                    </div>
                </button>
            </form>

            <div class="container_sent">
            <div class="img_sent">
                <svg xmlns="http://www.w3.org/2000/svg" width="239.325" height="194.271" viewBox="0 0 239.325 194.271">
                    <defs>
                        <style>
                            .a {
                                fill: #c30078;
